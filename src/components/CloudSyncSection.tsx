        ...
        <form onSubmit={(e) => void handleAuth(e)} className="space-y-4 p-gutter">
          ...
          <div className="flex flex-col gap-2">
            ...
            <button
              ...
              className="flex w-full cursor-not-allowed items-center justify-center gap-3 rounded-xl border border-outline-variant bg-surface-container px-4 py-3 text-body-md text-on-surface-variant opacity-50"
            >
              <svg
