...
export const TOUR_STEPS: TourStep[] = [
  ...
  },
  {
    ...
    title: 'Your Progress',
    body: 'Streak, journey day count, and next milestone — celebrate how far you have come.',
    placement: 'top',
    scroll: 'center',
  },
  {
    id: 'begin-journey',
    target: '[data-testid="begin-journey-btn"]',
    title: "Begin Today's Journey",
    body: 'Start a guided flow through scripture, meditation, prayer, and reflection — one step at a time.',
    placement: 'top',
    scroll: 'center',
  },
  {
  ...
  },
  {
    ...
    title: 'Quick Actions',
    body: 'Jump to journal, prayer, scripture, groups, or calendar without scrolling.',
    placement: 'top',
    scroll: 'center',
  },
  {
