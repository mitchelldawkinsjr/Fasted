...
- **Journal** — Morning devotions with search and JSON/Markdown export
...
UI/UX is synced from the Stitch project **Biblical Fasting Journey** (`projects/3997330998345860727`). Design tokens live in `.stitch/DESIGN.md` with full HTML exports per screen.
...
Push to `main` triggers GitHub Actions deploy when `VPS_SSH_KEY`, `VPS_HOST`, and `VPS_USER` secrets are configured (same as ghfb / WNBA-Stat-Spot).
