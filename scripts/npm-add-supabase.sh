#!/usr/bin/env bash
# Add db.fasted.360web.cloud proxy host to Nginx Proxy Manager (Supabase Kong).
...
add_proxy_host "db.fasted.360web.cloud" "supabase-kong" 8000

docker restart nginx-proxy
sleep 8
echo "NPM restarted. Request SSL cert for db.fasted.360web.cloud in NPM UI if HTTPS does not work."
