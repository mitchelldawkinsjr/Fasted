#!/usr/bin/env bash
# Add db.app.example.com proxy host to Nginx Proxy Manager (Supabase Kong).
...
add_proxy_host "db.app.example.com" "supabase-kong" 8000

docker restart nginx-proxy
sleep 8
echo "NPM restarted. Request SSL cert for db.app.example.com in NPM UI if HTTPS does not work."
